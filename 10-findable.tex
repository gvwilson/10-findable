...
researcher uses a particular set of data sources (Figure~1A), such
...
the lab (Figure~1B) which help visualize, identify or extrapolate
new observations about biological phenomena (Figure~1C). After
...
(Figure~1D). Finally, the researcher builds context for the work by
writing a manuscript and citing relevant literature (Figure~1E).
...
of discipline specific, and general repositories\cite{PLOS2020} (Figure~1F). 
...
IDs (ORCIDs)\cite{ORCID2020} (Figure~1G). Many repositories follow the standards
...
users (Figure~1F). This way nearly all of her major research products can be citable and
...
\subsection*{Figure~1: A typical research workflow.}

\noindent
A-E: Major steps of the research workflow.
...
\noindent
G: Persistent identifiers used for the example repositories listed.
