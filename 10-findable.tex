...
\\
\textbf{1} RStudio, PBC, Boston, Massachusetts, USA \\
\textbf{2} Louise M. Darling Biomedical Library, University of California, Los Angeles, California, USA
\\
\bigskip
...
\newblock {blogdown}: Creating Websites with R~Markdown.
...
\newblock {PLoS Biology}. 2014;12(1).
...
\newblock {PLoS} Computational Biology. 2017;13(6):1--20.
