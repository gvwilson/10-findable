...
%DIF ADD 10-findable.tex        Sat Oct 17 06:54:31 2020
\include{settings}
...
\begin{figure}
  ...
  \caption{A typical research workflow. A-E: Major \DIFdelbeginFL \DIFdelFL{components }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{steps }\DIFaddendFL of the research workflow.
  F: An example set of citable repositories or tools \DIFaddbeginFL \DIFaddFL{used to find research products 
  outside of journal articles}\DIFaddendFL . G: Persistent identifiers used
...
of discipline specific, and general repositories\cite{PLOS2020} \DIFaddbegin \DIFadd{(Figure~\ref{workflow}F)}\DIFaddend . 
