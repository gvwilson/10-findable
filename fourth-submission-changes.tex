...
%DIF DEL third-submission.tex   Sat Oct 17 06:51:15 2020
%DIF ADD 10-findable.tex        Tue Oct 20 11:39:49 2020
\include{settings}
...
communication channel in their own right. To illustrate this, \DIFaddbegin \DIFadd{the author Jorge
Luis }\DIFaddend Borges created a classification of animals whose categories included
...
locations. \DIFaddbegin \DIFadd{Furthermore, the surge in use of preprints and other similar reserach 
...
}\DIFaddend The second step in making things findable is to think ahead about
the things you would want to be found at the completion of the project\DIFaddbegin \DIFadd{, including
relevant preprints, }\DIFaddend before cataloging what you have. That way you can have time to 
...
researcher uses a particular set of data sources (Figure~\DIFdelbegin \DIFdel{\ref{workflow}A}\DIFdelend \DIFaddbegin \DIFadd{1A}\DIFaddend ), such
...
the lab (Figure~\DIFdelbegin \DIFdel{\ref{workflow}B}\DIFdelend \DIFaddbegin \DIFadd{1B}\DIFaddend ) which help visualize, identify or extrapolate
new observations about biological phenomena (Figure~\DIFdelbegin \DIFdel{\ref{workflow}C}\DIFdelend \DIFaddbegin \DIFadd{1C}\DIFaddend ). After
...
(Figure~\DIFdelbegin \DIFdel{\ref{workflow}D}\DIFdelend \DIFaddbegin \DIFadd{1D}\DIFaddend ). Finally, the researcher builds context for the work by
writing a manuscript and citing relevant literature (Figure~\DIFdelbegin \DIFdel{\ref{workflow}E}\DIFdelend \DIFaddbegin \DIFadd{1E}\DIFaddend ).
Manuscripts are revised by colleagues in the field through peer review
and published in a peer reviewed journal.

\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <   \includegraphics[width=\textwidth]{workflow.png}
%DIFDELCMD <   \captionsetup{justification=centering}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{A typical research workflow. A-E: Major components of the research workflow.
  ...
  %DIFAUXCMD
%DIFDELCMD < \label{workflow}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend By planning ahead, you can identify what research products can go where, and
...
of discipline specific, and general repositories\cite{PLOS2020} \DIFaddbegin \DIFadd{(Figure~1F)}\DIFaddend . 
Researchers can \DIFdelbegin \DIFdel{deposit }\DIFdelend \DIFaddbegin \DIFadd{archive and find }\DIFaddend research products created from each of the steps in the workflow\DIFdelbegin \DIFdel{(Figure~\ref{workflow}F)}\DIFdelend .
...
IDs (ORCIDs)\cite{ORCID2020} (Figure~\DIFdelbegin \DIFdel{\ref{workflow}G}\DIFdelend \DIFaddbegin \DIFadd{1G}\DIFaddend ). Many repositories follow the standards
...
users (Figure~\DIFdelbegin \DIFdel{\ref{workflow}F}\DIFdelend \DIFaddbegin \DIFadd{1F}\DIFaddend ). This way nearly all of her major research products can be citable and
...
\subsection*{\DIFadd{Figure~1: A typical research workflow.}}

\noindent
\DIFadd{A-E: Major steps of the research workflow.
}

\noindent
\DIFadd{F: An example set of citable repositories or tools used to find research products 
outside of journal articles.
}

\noindent
\DIFadd{G: Persistent identifiers used for the example repositories listed.
...
\noindent
\DIFadd{Some institutions maintain their own repositories for archiving data
and may be available to researchers at a low or no cost
}\DIFaddend 
